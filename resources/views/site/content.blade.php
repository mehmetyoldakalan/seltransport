@include('site.layouts.header')
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-lg-3">
                    <div class="card position-sticky top-1">
                        <ul class="nav flex-column bg-white border-radius-lg p-3">
                            <li class="nav-item">
                                <a class="nav-link text-body" data-scroll="" href="#genel-ayarlar">
                                    <div class="icon me-2">
                                    ...
                                    <span class="text-sm">Genel Ayarlar</span>
                                </a>
                            </li>
                            <li class="nav-item pt-2">
                                <a class="nav-link text-body" data-scroll="" href="#iletisim-bilgileri">
                                    <div class="icon me-2">
                                    ...
                                    <span class="text-sm">İletişim Bilgileri</span>
                                </a>
                            </li>
                            <li class="nav-item pt-2">
                                <a class="nav-link text-body" data-scroll="" href="#sosyal-medya">
                                    <div class="icon me-2">
                                    ...
                                    <span class="text-sm">Sosyal Medya</span>
                                </a>
                            </li>


                            <li class="nav-item pt-2">
                                <a class="nav-link text-body" data-scroll="" href="#analytic">
                                    <div class="icon me-2">
                                    ...
                                    <span class="text-sm">Analytic</span>
                                </a>
                            </li>

                            <li class="nav-item pt-2">
                                <a class="nav-link text-body" data-scroll="" href="#adminler">
                                    <div class="icon me-2">
                                    ...
                                    <span class="text-sm">Adminler</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-9 mt-lg-0 mt-4">
                    ...
                    <div class="card card-body" id="genel-ayarlar">
                        <div class="row justify-content-center align-items-center">
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <label for="example-file-input" class="form-control-label">Alt Logo</label>
                                    <input class="form-control" type="file" value="" id="example-file-input">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="card mt-4" id="iletisim-bilgileri">
                    ...
                    <div class="card mt-4" id="sosyal-medya">
                        <div class="card-header">
                            <h5>Sosyal Medya</h5>
                        </div>
                        <div class="card-body pt-0">
                    ...
                    <div class="card mt-4" id="analytic">
                        <div class="card-header">
                            <h5>Google Analytic</h5>
                            <p class="text-sm"> Birden fazla analytic kodu için aralarında boşluk bırakarak
                                yapıştırınız.</p>
                        </div>
                        <div class="card-body pt-0">
                    ...
                    <div class="card mt-4" id="adminler">
                        <div class="card-header">
                            <h5>Adminler</h5>
                                ...
                                <table class="table mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="ps-1 text-center">
                                                <p class="mb-0">İşlemler</p>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <script src="{{asset('site-assets/js/soft-ui-dashboard.min.js?v=1.0.5')}}"></script>
</body>
